 ...
 $id = $_GET['id'];
 $query = mysqli_query($koneksi, "select * from tb_rekening where id_rek='$id'");
...
<div class="col-md-6">
          ...
          <div class="box box-primary">
			...
			<?php
				...
				if($foto == ""){
						mysqli_query($koneksi, "update tb_rekening set nama_bank='$nama', atas_nama='$atas_nama', no_rek='$norek', status='$status' where id_rek='$id'");
						 ?>
						...
						mysqli_query($koneksi, "update tb_rekening set nama_bank='$nama', atas_nama='$atas_nama', no_rek='$norek', gambar='$foto', status='$status' where id_rek='$id'");
						?>
							<script type="text/javascript"> alert("Data Berhasil diupdate");
							  window.location.href="index.php?page=module/rekening/list_rek";
							</script> 
