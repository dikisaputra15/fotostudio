 ...
 $id = $_GET['id'];
 $query = mysqli_query($koneksi, "select * from tb_galerry where id_galery='$id'");
...
<div class="col-md-6">
          ...
          <div class="box box-primary">
			...
			<?php
				...
				if($foto == ""){
						mysqli_query($koneksi, "update tb_galerry set judul_keg='$judul' where id_galery='$id'");
						 ?>
						...
						mysqli_query($koneksi, "update tb_galerry set judul_keg='$judul', photo='$foto' where id_galery='$id'");
						?>
							<script type="text/javascript"> alert("Data Berhasil diupdate");
							  window.location.href="index.php?page=module/galerry/list_gal";
							</script> 
